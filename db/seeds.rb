...
k_gear = Gear.create(list: "Helmet, Goggles, Jacket, Pants, Gloves, Base layer, Socks, Boots, Rentals".red.bold, link: "https://store.christysports.com/store_locations/christy-sports-keystone-snake-river", resort: keystone)
b_gear = Gear.create(list: "Helmet, Goggles, Jacket, Pants, Gloves, Base layer, Socks, Boots, Rentals".red.bold, link: "https://store.christysports.com/store_locations/breckenridge-gondola", resort: breck)
v_gear = Gear.create(list: "Helmet, Goggles, Jacket, Pants, Gloves, Base layer, Socks, Boots, Rentals".red.bold, link: "https://store.christysports.com/store_locations/christy-sports-vail", resort: vail)
bc_gear = Gear.create(list: "Helmet, Goggles, Jacket, Pants, Gloves, Base layer, Socks, Boots, Rentals".red.bold, link: "https://store.christysports.com/store_locations/christy-sports-beaver-creek", resort: beaver_creek)
pc_gear = Gear.create(list: "Helmet, Goggles, Jacket, Pants, Gloves, Base layer, Socks, Boots, Rentals".red.bold, link: "https://store.christysports.com/store_locations/christy-sports-park-city", resort: park_city)
